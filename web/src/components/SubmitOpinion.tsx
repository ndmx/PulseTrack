  ...
  return (
    <div style={{ border: "1px solid #E9ECEF", borderRadius: 12, padding: 16, background: "#fff" }}>
      ...
      <details style={{ marginTop: 10 }}>
        ...
        <p>If you see submit failures, the database may be restricting public inserts. An admin can enable a read-safe insert policy for the table:</p>
        <pre style={{ whiteSpace: "pre-wrap" }}>create policy "allow_anon_insert_limited" on raw_inputs for insert to anon using (true) with check (char_length(content) &gt; 0);</pre>
      </details>
    </div>
  )
}
